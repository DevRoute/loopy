        ...
        >
          ...
          >
            <div className="relative">
              ...
              <div
                className="relative h-56 w-full mb-6 overflow-hidden rounded-xl bg-white p-3
                shadow-[0_0_15px_rgba(0,0,0,0.2)] group-hover:shadow-[0_0_20px_rgba(0,220,130,0.3)] transition-all duration-500"
              >
                <Image src="/img/zfb.jpg" alt="支付宝捐赠" fill className="object-contain" />
              </div>
          ...
          >
            <div className="relative">
              ...
              <div
                ...
                shadow-[0_0_15px_rgba(0,0,0,0.2)] group-hover:shadow-[0_0_20px_rgba(0,220,130,0.3)] transition-all duration-500"
              >
                <Image src="/img/wx.jpg" alt="微信捐赠" fill className="object-contain" />
              </div>
              <p className="text-slate-300 text-sm group-hover:text-white transition-colors duration-300">
                使用微信扫描二维码进行捐赠
              </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
            ...
            >
              <svg
                ...
                className="h-5 w-5 text-[#00DC82] group-hover:text-[#00DC82]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
