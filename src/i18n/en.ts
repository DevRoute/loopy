  ...
  projectList: [
    {
      ...
      status: 'Completed',
      description:
        'An Online IDE integrated with AI capabilities, providing a ready-to-use development environment to simplify the development process and improve efficiency.',
    ...
    },
    {
      ...
      status: 'Completed',
      description:
        'Create-Neat is a lightweight scaffolding tool designed to provide a ready-to-use and zero-configuration experience, aimed at helping users quickly and easily build projects while supporting a variety of technology stack choices.',
